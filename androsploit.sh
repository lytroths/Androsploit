...
echo -e "$cyan        |$white$green  Github  $white:$blue 	www.github.com/lytroths                    $cyan|"
echo -e "$cyan        |$white$green  Youtube $white:$blue 	(coming soon)                 		 $cyan|"
echo -e "$cyan        |$white$green  Website $white:$blue    (coming soon)                 $cyan|"
echo -e "$cyan        |$white$green  Email   $white:$blue 	codekarmabal@protonmail.com                    $cyan|"
echo -e "$cyan        ╘────────────────────────────────────────────────────────────────╝$nc\n"
...
clear
	echo -  e "           _                 _       _ _    
	       __ _ _ __   __| |_ __ ___  _ __ | | ___ (_) |_ 
         / _` | '_ \ / _` | '__/ _ \| '_ \| |/ _ \| | __|
        | (_| | | | | (_| | | | (_) | |_) | | (_) | | |_  
